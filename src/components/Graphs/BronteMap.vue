<template>
  <div class="map-bronte">
    <el-row class="animated fadeIn fd1">
		  <div id="map"></div>
    </el-row>
  </div>
</template>
...
export default {
  ...
  created () {
    ...
    this.countriesArray = [dataHeader, ...Object.entries(anglophoneReceptions["Charlotte Brontë"]).map((entry) => [entry[1].country, entry[1].receptions])]
