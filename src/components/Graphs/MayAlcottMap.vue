...
export default {
  ...
  created () {
    ...
    this.countriesArray = [dataHeader, ...Object.entries(anglophoneReceptions["Louisa May Alcott"]).map((entry) => [entry[1].country, entry[1].receptions])]
